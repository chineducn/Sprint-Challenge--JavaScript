...
// console.log(trexObj.weight);

// What was the diet of a velociraptor?
// console.log(veloObj.diet);

// How long was a stegosaurus?
// console.log(stegyObj.length);

// What time period did tyrannosaurus live in?
// console.log(trexObj.period);
...
const universities = [];
graduates.forEach(graduate => universities.unshift(graduate.university))
...
*/
const populationTotal = zooAnimals.reduce((count, animal) => count + animal.population, 0);
